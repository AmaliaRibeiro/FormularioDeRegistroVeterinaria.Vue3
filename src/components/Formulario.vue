...
const editando = computed(() => {  //nos permite si es que estamos editando el paciente guardar cambios y no aparece el cartel de registrar otra vez.
    return props.id
})
...
<template>
    <div class="md:w-1/2">
        ...
        <form class="bg-white shadow-md rounded-lg py-10 px-5 mb-10" @submit.prevent="validar">
            ...
            <div class="mb-5">
                <!--gracias al for se hace click en nombre mascota y se pronuncia los bordes-->
